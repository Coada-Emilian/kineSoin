...
export default function DescriptionSection({
  ...
  const articleImage = isPatientLoginPageDescriptionSection
  ...
  const articleAlt = isPatientLoginPageDescriptionSection
  ...
  const articleParagraph = isPatientLoginPageDescriptionSection
  ...
  const articleTitle = isPatientLoginPageDescriptionSection
  ...
  const reverseArticleImage = isPatientLoginPageDescriptionSection
  ...
  const reverseArticleAlt = isPatientLoginPageDescriptionSection
    ? "Homme faisant des exercices accompagnée d'une thérapeute"
    : isTherapistLoginPageDescriptionSection
  ...
  const reverseArticleParagraph = isPatientLoginPageDescriptionSection
  ...
  const reverseArticleTitle = isPatientLoginPageDescriptionSection
