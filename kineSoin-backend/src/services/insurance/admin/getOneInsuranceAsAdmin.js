/**
 * @description Retrieves a single insurance organization with formatted display information.
 *
 * Responsibilities:
 ...
 * - Retrieves the requested insurance organization.
 * - Formats address and phone information for application use.
 *
 * Notes:
