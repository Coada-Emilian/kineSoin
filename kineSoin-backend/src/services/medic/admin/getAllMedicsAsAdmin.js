/**
 * @description Retrieves all medics with formatted information for an authenticated admin.
 *
 * Responsibilities:
 * - Validates the provided admin identifier.
 * - Ensures the admin exists before accessing medic data.
 * - Retrieves medic records from the database.
 * - Formats medic information for frontend consumption.
 *
 * Notes:
