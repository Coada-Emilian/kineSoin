...
export const getAdminTableDetails = ({
  ...
  },
  {
    ...
    customBtnText: '+ Ajouter affection',
    modalName: 'addAffliction',
    regionButton: true,
    tableTitle: 'Toutes les affections',
    tableSubtitle: 'Gérez les affections de votre cabinet.',
    entityStatus: entityStatus,
    secondTableHeadContent: 'Nom',
    thirdTableHeadContent: 'Cotation',
    fourthTableHeadContent: 'Region',
  },
  {
    entityType: 'medic',
