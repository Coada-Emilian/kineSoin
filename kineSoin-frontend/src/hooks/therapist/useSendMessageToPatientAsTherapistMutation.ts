...
import { sendMessageToPatientAsTherapist } from '../../utils/functions/therapist/sendMessageToPatientAsTherapist';
    ...
    mutationFn: async ({
      ...
      if (!id || !formData) {
        ...
        if (!messageContent || messageContent.trim() === '') {
          ...
          await sendMessageToPatientAsTherapist(id, messageContent);
        }
      }
    },
    onSuccess: () => {
